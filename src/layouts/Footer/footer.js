        ...
        <Container fluid={true} className="footer-break footer-bg-blue">
            <Row>
                <Col md={{ size: 4, offset: 2 }}>
                    <Row>
                        <Col className="mb-5">
                            <p className="text-brand-landing footer-footer">React Movie</p>
                            <p className="text-footer-title footer-footer">Studio Ghibli API</p>
                ...
                <Col>
                    <Row>
                        <Col xs="6" md="2">
                            <p className="footer-footer-title">Information</p>
                        ...
                        <Col xs="6" md="2">
                            ...
                            <ul className="footer-links">
                                <li><a href="#">React Movie</a></li>
                                <li><a href="#">Studio Ghibli</a></li>
                                <li><a href="#">API Movie</a></li>
                            </ul>
                        </Col>
                        <Col xs="6" md="2">
